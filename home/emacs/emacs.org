...
#+begin_src emacs-lisp
  (setq user-mail-address "pedro.correa@gmail.com")
   ...
   #+begin_src emacs-lisp
     (defun tulkdan/org-font-setup ()
       ...
       (dolist (face '((org-level-1 . 1.2)
		       ...
		       (org-level-7 . 1.1)
		       (org-level-8 . 1.1)))
        (set-face-attribute (car face) nil :font "Departure Mono" :weight 'regular :height (cdr face)))
...
But first, let's install hide-mode-line to hide the modeline when presenting
#+begin_src emacs-lisp
...
* Cooklang
[[https://cooklang.org/][A recipe markup language]]
